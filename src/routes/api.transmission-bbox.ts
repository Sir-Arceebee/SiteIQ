...
/**
 * Returns electrical transmission lines whose geometry intersects the bbox.
 * Used by the map's "Show electrical grid" toggle for viewport-based loading.
 */
export const Route = createFileRoute("/api/transmission-bbox")({
  server: {
    handlers: {
      GET: async ({ request }) => {
        ...
        try {
          ...
          console.error("transmission-bbox error:", msg);
